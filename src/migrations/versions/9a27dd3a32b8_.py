...
Revision ID: 9a27dd3a32b8
Revises: 
Create Date: 2025-11-02 18:01:29.970961
...
def upgrade() -> None:
    ...
    op.create_table('facilities_rooms',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('facilities_id', sa.Integer(), nullable=False),
    sa.Column('rooms_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['facilities_id'], ['facilities.id'], ondelete='CASCADE'),
